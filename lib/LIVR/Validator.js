...
Validator.prototype = {
    ...
    validate: function(data) {
        ...
        var errors = {}, deepErrors = {}, result = {},
            allRules = this.livrRules;
        ...
        for (var fieldName in this.validators) {
            ...
            for (var i=0; i<validators.length; i++) {
                ...
                if (errCode) {
                    ...
                    deepErrors[fieldName] = {
                        code: errCode,
                        rule: allRules[fieldName][i]
                    };
                    break;
